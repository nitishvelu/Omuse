            ...
            >
              ...
              <GridItem rowSpan={[1, 1, 2]} colSpan={6}>
                ...
                <Heading fontSize={["3xl", "5xl", "7xl"]}>
                  {artist.name.replace(/(?:^|\s|["'([{])+\S/g, (match) =>
                    match.toUpperCase()
                  )}
                </Heading>
              </GridItem>
              <GridItem rowSpan={[1, 2, 2]} colSpan={6}>
                <StatGroup>
                  <Stat>
                    <StatLabel color="#AEC8CA">Number Of Followers</StatLabel>
              ...
              <GridItem colSpan={6}>
                ...
                >
                  {artist.email ? (
                    <Heading fontSize={["lg", "xl", "xl"]} color="#AEC8CA">
                ...
                {artist.total_streams ? (
                  <Heading fontSize={["lg", "xl", "xl"]} color="#AEC8CA">
                    {"Total Streams: ".concat(artist.total_streams)}
                  </Heading>
                ) : (
                  <Heading></Heading>
                )}
              ...
              <GridItem colSpan={6}>
                <Heading fontSize={["xl", "xl", "2xl"]}>Albums</Heading>
              ...
              <GridItem rowSpan={2} colStart={5}>
                ...
                >
                  <Box display="inline-flex">
                    <RiUserUnfollowLine onClick={handleClick} color="red" />
                    <Text onClick={handleClick} pl="2" color="red.300">
                      {follow.replace(/(?:^|\s|["'([{])+\S/g, (match) =>
                        match.toUpperCase()
                      )}
                    </Text>
                  </Box>
          ...
          >
            ...
            >
              ...
              <GridItem rowSpan={2} colStart={5}>
                ...
                >
                  <Box display="inline-flex">
                    <RiUserFollowFill onClick={handleClick} color="green" />
                    <Text onClick={handleClick} pl="2" color="green.300">
                      {follow.replace(/(?:^|\s|["'([{])+\S/g, (match) =>
                        match.toUpperCase()
                      )}
                    </Text>
