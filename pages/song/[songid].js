        ...
        <Flex h="80%" w="100%" justifyContent="center">
          ...
          >
            ...
            >
              ...
              <GridItem colSpan={6}>
                <NextLink href={"/artist/" + song_obj.artist_id} passHref>
                  <Link
                    _hover={{ textDecor: "none" }}
                    _focus={{ boxShadow: "none" }}
                  >
                    <Heading fontSize={["xl", "xl", "3xl"]} color="#AEC8CA">
              ...
              <GridItem rowSpan={[1, 2, 2]} colSpan={6}>
                <StatGroup>
                  <Stat>
                    <StatLabel color="#AEC8CA">Number of Likes</StatLabel>
                ...
                <NextLink href={"/album/" + song_obj.album_id} passHref>
                  ...
                  >
                    <Heading fontSize={["xl", "xl", "3xl"]}>
                      {song_obj.album.replace(/(?:^|\s|["'([{])+\S/g, (match) =>
                        match.toUpperCase()
                      )}
                    </Heading>
                  </Link>
              ...
              <GridItem colSpan={6}>
                <NextLink href={"/language/" + song_obj.language} passHref>
                  <Link
                    _hover={{ textDecor: "none" }}
                    _focus={{ boxShadow: "none" }}
                  >
                    <Heading color="#AEC8CA" fontSize={["lg", "xl", "xl"]}>
              ...
              <GridItem rowSpan={2} colStart={5}>
                ...
                >
                  <Box display="inline-flex">
                    <FaHeart onClick={handleClick} color="red" />
                    {/* <Text
                  onClick={handleClick}
                  pl='2'
                  color='green.300'
          ...
          >
            ...
            >
              ...
              <GridItem rowSpan={2} colStart={5}>
                ...
                >
                  <Box display="inline-flex">
                    <FaRegHeart onClick={handleClick} color="red" />
                    {/* <Text
                    onClick={handleClick}
                    pl='2'
                    color='green.300'
